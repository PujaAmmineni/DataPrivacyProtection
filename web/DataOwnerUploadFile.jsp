  ...
  <header class="header header--bg">
    <div class="container">
      <nav class="navbar">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="DataOwnerUploadFile.jsp">Upload</a></li>
            <li><a href="userlogin.jsp">Puja</a></li> 
      ...
      <div class="header__content text-center">
        <span class="header__content__block">upload file to cloud server</span>
        <p><form action="./DataownerUploadAction" method="POST" class="table-responsive" style="width:100%" enctype="multipart/form-data">
            <center><table>
                                    
                                    <tr style="color: white;"><td></td>
                                        <td>Select File</td>
                                        <td><input type="file" name="file" required="" accept=".txt"></td>
                                    </tr>
                                  
                                    <tr>
                                        <td></td><td></td>
                                        <td><button type="submit" value="Register" class="btn btn-common">Upload</button></td>
                                    </tr>
                                    <tr>
                                        <td>
