  ...
  <header class="header header--bg">
    <div class="container">
      <nav class="navbar">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="DataOwnerFileView.jsp">ViewFile</a></li> 
            <li><a href="DODownloadsDetails.jsp">DownloadFile</a></li> 
      ...
      <div class="header__content text-center">
        <span class="header__content__block">Download files</span>
        <p>
                        <table border="2px" class="table table-hover table-dark">
                                ...
                                <tbody>
                                    ...
                                    try(Connection con = DBConnectionn.getConnection()){
                                        String sqlQuery = "select *from downloads where ownername = ?";
                                     ...
                                     <tr scope="row" style="color: BLUE; background-color:#FFFCBB">
                                        ...
                                        <td><%=rs.getString("privatekey")%></td> 
                                        <td><%=rs.getString("publickey")%></td>
                                        <td><%=rs.getString("downloaddate")%></td>
                                    ...
                                    System.out.println("Error at Downloads users "+ex.getMessage());
                                    }
                                    %>
