  ...
  <header class="header header--bg">
    <div class="container">
      <nav class="navbar">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewUploadFile.jsp">Files</a></li>
      ...
      <div class="header__content text-center">
        <span class="header__content__block">view Files</span>
                                ...
                                <tbody>
                                    ...
                                    try(Connection con = DBConnectionn.getConnection()){
                                     ...
                                     <tr scope="row" style="color: BLUE; background-color:#FFFCBB">
                                        ...
                                        <td><a href="./DODownloadAction?id=<%=id%>">Download</a></td>
  ...
  <footer class="footer footer--bg">
    <div class="container text-center">
      ...
      <ul class="footer__contact-information">
        ...
        <li><a href="mailto:sshariar458@gmail.com"><i class="material-icons">email</i> lxa160cm@gmail.com</a></li>
        <li><a href="#"><i class="material-icons">location_on</i> DataPoint info solutions</a></li>
      </ul>
    </div>
