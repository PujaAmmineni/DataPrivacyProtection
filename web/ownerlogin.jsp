  ...
  <header class="header header--bg">
    <div class="container">
      ...
      <div class="header__content text-center">
        <span class="header__content__block">Owner login</span>
        <form action="owners_login" method="post">
                                    <h5 style="color:white">UserName:&nbsp;&nbsp;<input type="text" required name="name"/></h5><br>
                                    <h5 style="color:white">Password:&nbsp;&nbsp;<input type="password" required name="upass"/></h5><br>
                                ...
                                %>
                                <ul>
                                    <h5><li><a href="userreg.jsp" style="color:white">Register here</a></li></h5>
